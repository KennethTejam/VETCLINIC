...
namespace CLINIC
{
    public partial class ManageAccount : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            Clinic_MainLogo.Location = new Point(53, 22);
        ...
        {
            RecordHistory recordhistory = new RecordHistory(userid);
            recordhistory.Show();
            this.Hide();
        }
        ...
        public void OpenMessageBox(int userid)
        {
            ...
            using (var msgBox = new customMessageBox(text, userid))
            {
